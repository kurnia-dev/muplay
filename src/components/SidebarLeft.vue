<template>
    <aside class="basis-[30%] flex-shrink-0 max-w-[400px] hidden sm:flex flex-col gap-[6rem] relative h-full overflow-auto">
        <div class="flex flex-col gap-6 sticky top-0 pb-5 bg-[var(--body-bg)] py-8 px-12">
